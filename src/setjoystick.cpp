...
JoyButton *SetJoystick::getJoyButton(int index) { return buttons.value(index); }

JoyAxis *SetJoystick::getJoyAxis(int index) { return axes.value(index); }

JoyDPad *SetJoystick::getJoyDPad(int index) { return hats.value(index); }

VDPad *SetJoystick::getVDPad(int index) { return vdpads.value(index); }

JoyControlStick *SetJoystick::getJoyStick(int index) { return sticks.value(index); }
...
int SetJoystick::getNumberButtons() { return buttons.count(); }

int SetJoystick::getNumberAxes() { return axes.count(); }

int SetJoystick::getNumberHats() { return hats.count(); }

int SetJoystick::getNumberSticks() { return sticks.size(); }

int SetJoystick::getNumberVDPads() { return vdpads.size(); }
...
void SetJoystick::addControlStick(int index, JoyControlStick *stick)
{
    ...
    while (iter.hasNext())
    {
        ...
        if (button)
        {
            ...
            connect(button, SIGNAL(setAssignmentChanged(int, int, int, int)), this,
                    SLOT(propogateSetStickButtonAssociation(int, int, int, int)));
...
void SetJoystick::addVDPad(int index, VDPad *vdpad)
{
    ...
    while (iter.hasNext())
    {
        ...
        if (button)
        {
            connect(button, SIGNAL(setChangeActivated(int)), this, SLOT(propogateSetChange(int)));
            connect(button, SIGNAL(setAssignmentChanged(int, int, int, int)), this,
                    SLOT(propogateSetVDPadButtonAssociation(int, int, int, int)));
...
int SetJoystick::getIndex() { return index; }

unsigned int SetJoystick::getRealIndex() { return index + 1; }
...
void SetJoystick::enableAxisConnections(JoyAxis *axis)
{
    ...
    connect(button, SIGNAL(setChangeActivated(int)), this, SLOT(propogateSetChange(int)));
    connect(button, SIGNAL(setAssignmentChanged(int, int, int, int)), this,
            SLOT(propogateSetAxisButtonAssociation(int, int, int, int)));
...
void SetJoystick::enableHatConnections(JoyDPad *dpad)
{
    ...
    while (iter.hasNext())
    {
        ...
        connect(button, SIGNAL(setChangeActivated(int)), this, SLOT(propogateSetChange(int)));
        connect(button, SIGNAL(setAssignmentChanged(int, int, int, int)), this,
                SLOT(propogateSetDPadButtonAssociation(int, int, int, int)));
...
InputDevice *SetJoystick::getInputDevice() { return device; }
...
QString SetJoystick::getName() { return name; }
