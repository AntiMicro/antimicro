...
void AutoProfileWatcher::startTimer() { appTimer.start(CHECKTIME); }

void AutoProfileWatcher::stopTimer() { appTimer.stop(); }
...
bool AutoProfileWatcher::isGUIDLocked(QString guid) { return guidSet.contains(guid); }
